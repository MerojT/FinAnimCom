...
function Header() {
  ...
  return (
    <header style={{ position: "sticky", top: 0, zIndex: 50, background: "var(--bg)", borderBottom: "3px solid var(--line)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 28px" }}>
      <Link to="/" style={{ fontFamily: "var(--font-display)", fontSize: "24px", textDecoration: "none", color: "var(--text)" }}>
        Fin
